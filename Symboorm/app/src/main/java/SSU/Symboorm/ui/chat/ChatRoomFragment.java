...
import SSU.Symboorm.model.ChatRoomModel;
...
public class ChatRoomFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        RecyclerView recyclerView = view.findViewById(R.id.rc_chatroom);
    ...
    class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
        ...
        void getRoomInfo() {
            listenerRegistration = firestore.collection("rooms").whereGreaterThanOrEqualTo("users."+myUid, 0)
                    .addSnapshotListener((value, e) -> {
                        ...
                        TreeMap<Date, ChatRoomModel> orderedRooms = new TreeMap<>(Collections.reverseOrder());
        ...
        public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
            ...
            if (chatRoomModel.getPhoto()==null) {
                ...
                Glide.with(requireActivity()).load(storageReference.child("userPhoto/"+chatRoomModel.getPhoto()))
                        .apply(requestOptions)
                        .into(roomViewHolder.room_image);
            }
