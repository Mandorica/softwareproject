...
import SSU.Symboorm.LoginActivity;
import SSU.Symboorm.R;
import SSU.Symboorm.UserPWActivity;
...
public class UserFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        logOutBtn.setOnClickListener(logOutBtnBtnClickListener);
    ...
    private Button.OnClickListener userPhotoIVClickListener = new View.OnClickListener() {
    ...
    private Button.OnClickListener saveBtnClickListener = new View.OnClickListener() {
        public void onClick(final View view) {
            ...
            db.collection("users").document(uid)
                    ...
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            if (userPhotoUri==null) {
                                Util.INSTANCE.showMessage(getActivity(), "Success to Save.");
                            } else {
                                // small image
    ...
    private Button.OnClickListener changePWBtnClickListener = new View.OnClickListener() {
        public void onClick(final View view) {
            startActivity(new Intent(getActivity(), UserPWActivity.class));
        }
    };
    private Button.OnClickListener logOutBtnBtnClickListener = new View.OnClickListener() {
        public void onClick(final View view) {
